...
**Триггерная функция** (**триггерная процедура**\*) - SQL-функция. Мы познакомились с ними в [прошлой статье](..%2F110%2FPL_pgSQL.%20Functions%20and%20procedures.md). Но есть небольшой нюанс, о нем - в следующем разделе.
