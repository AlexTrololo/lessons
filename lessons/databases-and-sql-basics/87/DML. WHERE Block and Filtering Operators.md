DML. Блок WHERE и операторы фильтрации – Telegraph

DML. Блок WHERE и операторы фильтрации
======================================

[Дорогу осилит идущий](https://t.me/ViamSupervadetVadens)July 09, 2023
...
select \* from passenger where first\_name like 'Iv%';
...
select \* from passenger where first\_name like 'I\_\_n';
...
select \* from passenger where first\_name in ('Ivan', 'Petr');
select \* from passenger where birth\_date in ('1990-07-02', '1993-07-02');
...
select \* from passenger where birth\_date between '1990-07-02' and '1993-07-02';
...
select \* from passenger where birth\_date >= '1990-07-02' and birth\_date <= '1993-07-02';
...
select \* from passenger where birth\_date between symmetric '1990-07-02' and '1993-07-02';

и

select \* from passenger where birth\_date between symmetric '1993-07-02' and '1990-07-02';
...
select \* from passenger where birth\_date not between '1993-07-02' and '1990-07-02';
...
select \* from passenger where (birth\_date, now()) overlaps ('1990-07-02'::date, '1993-07-02'::date);
...
![](/file/91a006ce440cb1c4bbd1f.png)
...
Please submit your DMCA takedown request to [\[email protected\]](/cdn-cgi/l/email-protection#)

Cancel Report

var T={"apiUrl":"https:\\/\\/edit.telegra.ph","datetime":1688910902,"pageId":"fc6391b51bdb215c49a1b","editable":true};(function(){var b=document.querySelector('time');if(b&&T.datetime){var a=new Date(1E3\*T.datetime),d='January February March April May June July August September October November December'.split(' ')\[a.getMonth()\],c=a.getDate();b.innerText=d+' '+(10>c?'0':'')+c+', '+a.getFullYear()}})();